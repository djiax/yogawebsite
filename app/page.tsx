  ...
  return (
    ...
    <div className='flex flex-col min-h-screen justify-center items-center px-55'>
      ...
      <div className='flex flex-col justify-center items-center mt-10'>
        <div className='text-4xl border rounded-xl p-3 text-transparent bg-clip-text bg-gradient-to-r from-[#f45899] to-[#654ea3]'>The Nature of Yoga</div>
      ...
      <div className='flex flex-col justify-center items-center'>
        <div className='mt-12 text-3xl border-b text-transparent bg-clip-text bg-gradient-to-r from-[#f45899] to-[#654ea3]'>Dimension of Yoga</div>
